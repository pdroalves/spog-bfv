...
if (DOXYGEN_FOUND)
  ...
  set(doxyfile_in ${CMAKE_SOURCE_DIR}/doc/spog.doxygen.in)
  set(doxyfile ${CMAKE_BINARY_DIR}/doc/spog.doxygen)

	
	if (EXISTS ${doxyfile_in})
		message(STATUS "Configured ${doxyfile_in}")
		configure_file(${CMAKE_CURRENT_SOURCE_DIR}/doc/spog.doxygen.in
			${CMAKE_CURRENT_BINARY_DIR}/doc/spog.doxygen @ONLY )
	...
	ADD_CUSTOM_TARGET(doc ${DOXYGEN_EXECUTABLE} ${doxyfile} WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} COMMENT "Generating API documentation with Doxygen" VERBATIM)
